...
int main() {
  ...
  // cin >> N; long long S = 0;
    ...
    dp.at(0).at(0) = a.at(0);
    rep(i,1,n) dp.at(0).at(i) = dp.at(0).at(i-1) + a.at(i);
    dp.at(1).at(0) = dp.at(0).at(n-1);
    rep(i,1,n) dp.at(1).at(i) = dp.at(1).at(0) - dp.at(0).at(i-1);

    // rep(i,0,n) cout << dp.at(0).at(i) << " ";
    // cout << endl;
    ...
    rep(i,0,n-1) chmin(ans, abs(dp.at(0).at(i)-dp.at(1).at(i+1)));

    chmin(ans,dp.at(1).at(0)-dp.at(0).at(n-1));
    cout << ans << "\n";
