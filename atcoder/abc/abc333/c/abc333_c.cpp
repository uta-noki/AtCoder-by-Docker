...
int main() {
    ...
    ll n;
    cin >> n;
    vector<ll> nm = {1,11,111,1111,11111,111111,1111111,11111111,111111111,1111111111,11111111111,111111111111};
    vector<ll> cnt{3};
    map<ll,ll> mp;
    ...
    rep(i,0,nm.size()) {
        rep(j,0,nm.size()) {
            rep(k,0,nm.size()) {
                //cout << cnt.back() << " ";
                if (find(cnt.begin(),cnt.end(),nm.at(i)+nm.at(j)+nm.at(k))==cnt.end()) cnt.push_back(nm.at(i)+nm.at(j)+nm.at(k));
            }
        }
    } 
    sort(cnt.begin(),cnt.end());
    // rep(i,0,cnt.size()) cout << cnt[i] << " ";
