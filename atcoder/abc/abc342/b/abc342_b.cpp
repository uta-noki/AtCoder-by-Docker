...
int main() {
    ...
    cin >> q;
    vector<int> a(q,0), b(q,0);
    rep(i,0,q) cin >> a.at(i) >> b.at(i);

    rep(i,0,q) {
      bool flag1 = false, flag2 = false;
      rep(j,0,n) {
        if (a.at(i)==p.at(j) && !flag1) flag1 = true;
        if (b.at(i)==p.at(j) && !flag2) flag2 = true;
        if (flag1) {cout << p.at(j)<< "\n"; break;}
        if (flag2) {cout << p.at(j)<< "\n"; break;}
      }
    }
