...
int main() {
    ...
    rep(i,0,n) c.push_back(a.at(i));
    rep(i,0,m) c.push_back(b.at(i));

    sort(c.begin(),c.end());
    
    rep(i,0,m+n-1) {
      // auto it1 = find(a.begin(),a.end(),c.at(i));
      // auto it2 = find(a.begin(),a.end(),c.at(i+1));
      if (count(a.begin(),a.end(),c.at(i)) && count(a.begin(),a.end(),c.at(i+1))) {
