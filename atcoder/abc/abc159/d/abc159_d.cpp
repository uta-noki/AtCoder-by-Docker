...
int main() {
    ...
    rep(i,1,n+1) {
      cnt += (num.at(i)*(num.at(i)-1))/2;
    }
    // cout << cnt << "\n";
      

    rep(i,0,n) {
      cout << cnt - (mp[a.at(i)] * (mp[a.at(i)]-1))/2 + (mp[a.at(i)]-1)*(mp[a.at(i)]-2)/2 << "\n";
      // int num_i = num.at(i);
      // num.at(num_i)--;
      // cout << cnt - (num.at(i)*(num.at(i)-1))/2 + ((num.at(i)-1)*(num.at(i)-2)/2) << "\n";
    }
