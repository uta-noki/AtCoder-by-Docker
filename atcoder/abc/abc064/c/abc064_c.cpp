...
int main() {
    ...
    rep(i,0,n) {
      if (1<=a.at(i) && a.at(i)<=399) ans.insert(1);
      else if (400<=a.at(i) && a.at(i)<=799) ans.insert(2);
      else if (800<=a.at(i) && a.at(i)<=1199) ans.insert(3);
      else if (1200<=a.at(i) && a.at(i)<=1599) ans.insert(4);
      else if (1600<=a.at(i) && a.at(i)<=1999) ans.insert(5);
      else if (2000<=a.at(i) && a.at(i)<=2399) ans.insert(6);
      else if (2400<=a.at(i) && a.at(i)<=2799) ans.insert(7);
      else if (2800<=a.at(i) && a.at(i)<=3199) ans.insert(8);
      else {cnt++; cnt_mx=1;}
    }

    if (ans.size()==0) cout << 1 << " " << cnt << "\n";
    else if (cnt_mx=0) cout << ans.size() << " " << ans.size() << "\n";
    else cout << ans.size() << " " << ans.size() + cnt << "\n";
