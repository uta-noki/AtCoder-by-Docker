...
int main() {
    ...
    vector<ll> div = arrangeDivisor(n);
    // rep(i,0,div.size()) cout << div.at(i) << " ";
    // cout << endl;
    // else {
    //   cout << arrangeDivisor(n)[0] + n/arrangeDivisor(n)[0] << "\n";
    // }
    // rep(i,0,div.size()) {
    //   rep(j,i+1,div.size()) {
    //     ans = min(ans,div.at(i)+div.at(j));
    //   }
    // }
    rep(i,0,div.size()) {
      ans = min(ans,div.at(i)+n/div.at(i)-2);
    }
